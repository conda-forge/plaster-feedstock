...
All platforms:
[![noarch](https://img.shields.io/circleci/project/github/conda-forge/plaster-feedstock/master.svg?label=noarch)](https://circleci.com/gh/conda-forge/plaster-feedstock)
...
Once the `conda-forge` channel has been enabled, `plaster` can be installed with:

```
conda install plaster
```

It is possible to list all of the versions of `plaster` available on your platform with:
